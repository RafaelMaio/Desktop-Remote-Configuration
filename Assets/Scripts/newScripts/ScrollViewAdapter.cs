...
public class ScrollViewAdapter : MonoBehaviour
{
    ...
    public class ExampleItemView
    {
        ...
        /// Item texts.
        /// </summary>
        public Text reference, localization, piece_name;
        ...
        {
            reference = rootView.Find("ReferenceText").GetComponent<Text>();
            piece_name = rootView.Find("NameText").GetComponent<Text>();
            localization = rootView.Find("LocalizationText").GetComponent<Text>();
