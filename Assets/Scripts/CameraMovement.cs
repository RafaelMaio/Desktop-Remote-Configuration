...
public class CameraMovement : MonoBehaviour
{
    ...
    /// </summary>
    [SerializeField] float navigationSpeed = 0.0003f;

    /// <summary>
    /// Camera scaling speed.
    /// </summary>
    [SerializeField] float navigationScaleSpeed = 3f;
    ...
    void Update()
    {
        ...
        float speed = navigationSpeed * (Input.GetKey(KeyCode.LeftShift) ? shiftMultiplier : 1f) * Time.deltaTime * 1.9f;
        /*
